...
const BottomNavigation: React.FC = () => {
  ...
  const getButtonClass = (path: string) => 
    `flex-col h-auto py-3 px-2 min-h-[60px] ${isActive(path) ? 'text-primary' : 'text-gray-500'} hover:bg-gray-50 transition-colors`;

  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-2 py-3 z-50 safe-area-inset-bottom shadow-lg">
      <div className="flex justify-around items-stretch max-w-md mx-auto gap-1">
        <Button 
          variant="ghost" 
        ...
        >
          ...
          <span className="text-xs font-medium leading-tight">One Punch<br/>Left</span>
        </Button>
